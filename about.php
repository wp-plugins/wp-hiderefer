...
$plugin_title = 'WP-HideRefer';
$plugin_forum = 'http://wordpress.org/tags/wp-hiderefer?forum_id=10';
...
<style type="text/css">
	#about{ float: right; width:350px; margin-right:14px; position: absolute; top: 60px; right: 1px; background: #ffc; border: 1px solid #333; padding: 5px; text-align: justify; font-family:verdana; font-size:11px;}
	#about h3 {text-align:center;}
	.field_info {text-align:right;};
</style>
<?php echo "<div id='about'> 
	<h3>From the author</h3> 				
	<p>Hi! My name is <a href='{$author_site}'>Ulf Benjaminsson</a>, I live on a small island just east of Sweden and have developed for WordPress since 2007. Nice to meet you! :)<p>
